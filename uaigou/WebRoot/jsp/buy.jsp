	...
	<head>
		...
		<script>
			...
			function myPay(){
				...
				var sids = document.getElementsByName("sid");//购物车的Sid
				var urlStr = "order?m=toPay&adrid="+adrid;
				for(var i=0;i<sids.length;i++){
					urlStr += "&sid="+sids[i].value;
				}
						...
						<tbody>
							<c:forEach var="s" items="${shopList}">
								...
								<tr>
									...
									<td align="center">
										￥<fmt:formatNumber type="number" value="${s.price*s.goodsNum }" pattern="0.00" maxFractionDigits="2"/>
									</td>
								</tr>
							</c:forEach>
						</tbody>
		...
		<div class="layui-container" style="top: -20px;">
			<div class="layui-row  my-shopping-buy">
				<div class="layui-col-md12">
					...
					<div class="my-buyBtn">
						总价：
						￥<font id="my-totalMoney" style="font-size: 20px;font-weight: bold;color:#FF4400;">${tm}</font>
