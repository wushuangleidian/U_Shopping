 ...
 */
@WebServlet("/zhifu")
public class ZhifuServlet extends BaseServlet {
	 ...
	 * 验证支付结果
	 */
	public String checkpay(HttpServletRequest request,HttpServletResponse response) throws Exception{
		String orderNo = request.getParameter("orderNo");
		int status = new MyOrderServiceImpl().getStatus(orderNo);
